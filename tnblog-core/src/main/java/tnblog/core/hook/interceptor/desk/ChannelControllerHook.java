package tnblog.core.hook.interceptor.desk;

import tnblog.core.hook.interceptor.InterceptorHookSupport;
...
public class ChannelControllerHook extends InterceptorHookSupport {
    ...
    public String[] getInterceptor() {
        //说明要拦截的controller
        return new String[]{"tnblog.web.controller.desk.ChannelController"};
    }
